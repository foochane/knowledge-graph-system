  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        >
        <el-breadcrumb-item>三元组分类</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      <div class="content-title">三元组分类</div>
      <div class="plugins-tips">输入需要判断的三元组</div>
      ...
      <div class="form-box">
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item>
            <el-button type="primary" @click="onSubmit">三元组分类</el-button>
